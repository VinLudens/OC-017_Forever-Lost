...
right = \relative c'' {
  ...
  \repeat unfold 6 { <b=' fis'>16 } \repeat unfold 2 { <b gis'>16 <b fis'> }  <b gis'>16 <b fis'>\) |
  <b=' fis'>\( \repeat unfold 5 { <b=' fis'> } <b g'> <b a'> <b g'> <b fis'> <b e> <b fis'>\) |
  <b=' fis'>16\( \repeat unfold 5 { <b=' fis'>16 } \repeat unfold 6 { <ais fis'>16 } |
  ...
  <b dis gis>4.) \clef "treble^8" cis''=''''8.\( dis8. |
  \grace { ais='''16 b } <fis=''' ais>2.\) |
  <cis=''' dis gis>4.\( ais'8. b |
  <b,='' cis fis>2.\) |
  %% -- E1 -- %%
